...
export const courses: Course[] = [
  {
    ...
    subCourses: [
      ...
      {
        titleEn: "Ten Qira'at Online — Advanced Recitations Program",
        titleAr: "القراءات العشر أونلاين — برنامج القراءات المتقدم",
        descEn: "An elite program for advanced Ijazah holders to master the Ten Qira'at (recitations) of the Holy Quran with certified scholars carrying an unbroken Sanad. Deep study of the Shatibiyyah and Durrah, with dedicated one-on-one sessions and personalized memorization and application plans.",
        descAr: "برنامج نخبوي لحملة الإجازة المتقدمين لإتقان القراءات العشر للقرآن الكريم مع علماء معتمدين يحملون السند المتصل. دراسة معمّقة للشاطبية والدرة، مع جلسات فردية مخصصة وخطط حفظ وتطبيق شخصية.",
        highlightsEn: ["Ten Qira'at with Sanad", "Shatibiyyah & Durrah study", "One-on-one with Qira'at scholars", "Advanced Ijazah holders track"],
        highlightsAr: ["القراءات العشر بالسند", "دراسة الشاطبية والدرة", "جلسات فردية مع علماء القراءات", "مسار حملة الإجازة المتقدمين"],
      },
    ],
    ...
    faqs: [
      ...
      { questionEn: "How long does it take to learn to read Quran online?", questionAr: "كم يستغرق تعلم قراءة القرآن أونلاين؟", answerEn: "The timeline is personalized. After a free assessment, your teacher builds a plan that matches your current level and the pace you can sustain. Starting with Noorani Qaida online, students progress through letter recognition, connected reading, and then independent Quran reading — as fast or as steadily as suits them.", answerAr: "الوتيرة مخصصة لكل طالب. بعد حصة تقييم مجانية، يضع لك المعلم خطة تناسب مستواك الحالي والوتيرة التي يمكنك الالتزام بها. تبدأ من النورانية ثم تعلم الحروف والقراءة المتصلة وصولًا للقراءة المستقلة، بالسرعة التي تناسبك." },
