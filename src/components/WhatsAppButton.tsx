...
const WhatsAppSvg = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" {...props}>
