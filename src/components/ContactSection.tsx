            ...
            <div className="mt-10 pt-8 border-t border-border">
              <div className="bg-whatsapp/5 border border-whatsapp/20 rounded-2xl p-6 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-3.5 rounded-xl bg-whatsapp text-whatsapp-foreground font-semibold text-base hover:brightness-110 transition-all shadow-lg hover:shadow-xl"
                >
