            ...
            <div className="mt-10 pt-8 border-t border-border">
              <div className="bg-[#25D366]/5 border border-[#25D366]/20 rounded-2xl p-6 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-3.5 rounded-xl bg-[#25D366] text-white font-semibold text-base hover:bg-[#22c55e] transition-colors shadow-lg hover:shadow-xl"
                >
