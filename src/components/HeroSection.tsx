      ...
      <div className="container relative z-10 mx-auto px-6 pb-16 pt-24 sm:px-8 md:pt-32 lg:px-16 lg:pt-32 xl:px-20">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="text-center lg:text-start">
            ...
            <h1 className="animate-fade-up motion-delay-100 mb-4 text-[2rem] font-bold leading-[1.3] tracking-[-0.02em] text-primary-foreground sm:text-4xl sm:leading-[1.25] md:text-5xl md:leading-[1.22] md:tracking-[-0.03em] lg:text-[3.35rem] xl:text-6xl">
              {t("One-on-One Quran & Arabic Classes", "دروس قرآن وعربية فردية")}
              <br />
              <span className="mt-1 block text-gradient-gold text-[1.6rem] leading-[1.35] sm:text-3xl sm:leading-[1.3] md:text-4xl md:leading-[1.25] lg:text-[2.8rem] xl:text-5xl">
