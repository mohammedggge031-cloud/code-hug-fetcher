...
const FloatingBookingFAB = () => {
  ...
  return (
    <button
      ...
      className="touch-fixed-ui floating-action-shell floating-fab-booking fab-gentle-bounce group relative"
      aria-label={t("Book a Free Trial", "احجز حصة مجانية")}
      style={{ animationDelay: "0.25s" }}
    >
      <span className="relative flex h-11 w-11 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-soft md:h-12 md:w-12 lg:shadow-elevated" style={{ overflow: 'visible' }}>
