        ...
        <motion.div {...fadeIn()}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-whatsapp/30 text-whatsapp font-semibold text-sm hover:bg-whatsapp/10 transition-colors"
            >
