...
const OnlineQuranClasses = () => (
  <ServicePageLayout
    ...
    featuresEn={[
      ...
      "Affordable pricing offering the best value per session with family discounts available",
    ...
    featuresAr={[
      ...
      "أسعار معقولة أفضل قيمة لكل جلسة مع خصومات عائلية",
    ...
    faqs={[
      ...
      { questionEn: "How much do online Quran classes cost?", questionAr: "كم تكلفة دروس القرآن أونلاين؟", answerEn: "Our online Quran classes pricing is very competitive — significantly lower than most online Quran academies. We offer various plans including 2, 3, 4, or 5 classes per week. Family discounts are available for multiple students enrolling together. All plans include progress reports, homework, and access to our teacher for questions between classes. Visit our pricing page for current rates.", answerAr: "أسعار دروسنا تنافسية جداً — أقل بكثير من معظم أكاديميات القرآن. نقدم خطط متنوعة تشمل 2، 3، 4، أو 5 حصص أسبوعياً. خصومات عائلية متاحة. جميع الخطط تشمل تقارير التقدم والواجبات والتواصل مع المعلم بين الحصص. زوروا صفحة الأسعار للاطلاع على التفاصيل." },
