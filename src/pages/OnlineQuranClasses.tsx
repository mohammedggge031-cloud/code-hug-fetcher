...
const OnlineQuranClasses = () => (
  <ServicePageLayout
    ...
    featuresEn={[
      ...
      "Affordable pricing starting best value per session with family discounts available",
    ...
    featuresAr={[
      ...
      "أسعار معقولة تبدأ أفضل قيمة لكل جلسة مع خصومات عائلية",
