...
const SITE_PAGES: { path: string; name: string; title?: string; description?: string; keywords?: string }[] = [
  ...
  { path: "/pricing", name: "Pricing (Dynamic Plans)", title: "Quran Classes Pricing | Monthly, 6-Month & Annual Plans | Alhamd Academy", description: "Transparent pricing for one-on-one online Quran classes. Choose your session length and weekly frequency. Free trial included.", keywords: "online quran classes pricing, quran subscription, quran academy fees" },
  { path: "/about", name: "About", title: "About Alhamd Academy | Certified Al-Azhar Quran & Arabic Teachers", description: "Learn about Alhamd Academy — our mission, our certified Al-Azhar teachers, and how we deliver one-on-one online Quran, Tajweed, Hifz and Arabic classes worldwide.", keywords: "about alhamd academy, al-azhar quran teachers, online quran academy" },
  { path: "/reviews", name: "Reviews", title: "Student Reviews & Testimonials | Alhamd Academy", description: "Read verified reviews from Alhamd Academy students worldwide. Real experiences learning Quran, Tajweed, Hifz and Arabic online with certified Al-Azhar teachers.", keywords: "alhamd academy reviews, quran academy testimonials, online quran classes reviews" },
