...
const QuranClassesWithCertificate = () => (
  <ServicePageLayout
    ...
    aboutContentAr={[
      ...
      "جمال برنامج الإجازة أونلاين هو الوصولية. سابقاً، الحصول على إجازة تطلب السفر. الآن يمكنك الحصول على هذه الشهادة المرموقة من بيتك في أي مكان — بأسعار تنافسية لا تُقارن.",
    ]}
    ...
    featuresEn={["Ijazah with connected Sanad to Prophet ﷺ", "Level completion certificates", "Certified Mujaaz teachers", "One-on-one intensive training", "Unbeatable rates for Ijazah program", "Recognized by Islamic institutions", "Online — study from anywhere", "Free trial to discuss your goals"]}
    featuresAr={["إجازة بسند متصل بالنبي ﷺ", "شهادات إتمام المستوى", "معلمون مجازون معتمدون", "تدريب فردي مكثف", "أسعار تنافسية لبرنامج الإجازة", "معترف بها من المؤسسات الإسلامية", "أونلاين — ادرس من أي مكان", "تجربة مجانية لمناقشة أهدافك"]}
    faqs={[
      ...
      { questionEn: "How much does the Ijazah program cost?", questionAr: "كم يكلف برنامج الإجازة؟", answerEn: "Our Ijazah program is offered at unbeatable rates — significantly less than what most institutions charge. The total cost depends on your starting level and how quickly you progress. Most students complete the program in 6–12 months.", answerAr: "برنامج الإجازة بأسعار تنافسية — أقل بكثير مما تتقاضاه معظم المؤسسات. التكلفة الإجمالية تعتمد على مستواك الأولي وسرعة تقدمك." },
    ...
    testimonials={[
      { name: "Imam Abdullah K.", country: "USA", textEn: "I received my Ijazah in Hafs through Alhamd Academy after 8 months of intensive one-on-one training. The Sanad is authentic and the teacher was exceptional. Best investment I've ever spent.", textAr: "حصلت على إجازتي في حفص من أكاديمية الحمد بعد 8 أشهر من التدريب المكثف الفردي. السند أصيل والمعلم استثنائي. أفضل استثمار أنفقتها.", rating: 5 },
