...
const CHALLENGES: Challenge[] = [
  ...
  { problemEn: "\"How long does the Ijazah take?\"", problemAr: "\"كم يستغرق الحصول على الإجازة؟\"", solutionEn: "Ijazah in Tajweed (recitation from the mus'haf) typically takes 8–14 months with 3–5 weekly sessions. Ijazah in Hifz depends on your existing memorization level and usually takes 6–18 months to seal.", solutionAr: "إجازة التجويد (التلاوة من المصحف) عادةً 8–14 شهرًا بمعدل 3–5 حصص أسبوعية. إجازة الحفظ تعتمد على مستواك في الحفظ وتحتاج غالبًا 6–18 شهرًا لختمها." },
...
const CURRICULUM: CurriculumWeek[] = [
  ...
  { weekEn: "Phase 2 — Ijazah Khatmah Begins", weekAr: "المرحلة 2 — بدء ختمة الإجازة", topicEn: "Continuous Talaqqi from Al-Fatiha", topicAr: "تلقٍّ متصل من الفاتحة", detailsEn: ["Formal Khatmah opens under the shaykh's ear from Surah Al-Fatiha", "Every page recited to the shaykh until fully corrected", "Weekly written progress notes and error log", "Consistent 3–5 weekly sessions to maintain momentum"], detailsAr: ["افتتاح الختمة الرسمية على الشيخ من سورة الفاتحة", "كل صفحة تُتلى على الشيخ حتى تُصحَّح كليًا", "ملاحظات تقدم أسبوعية مكتوبة وسجل للأخطاء", "3–5 حصص أسبوعية بانتظام للحفاظ على الوتيرة"] },
...
const FAQS: FAQ[] = [
  ...
  { questionEn: "How long will the Ijazah take?", questionAr: "كم يستغرق الحصول على الإجازة؟", answerEn: "Ijazah in Tajweed typically takes 8–14 months with 3–5 sessions weekly. Ijazah in Hifz varies from 6 to 18 months depending on the strength of your existing memorization when you begin.", answerAr: "إجازة التجويد عادةً 8–14 شهرًا بمعدل 3–5 حصص أسبوعية. إجازة الحفظ تتراوح من 6 إلى 18 شهرًا بحسب قوة حفظك عند البدء." },
  ...
  { questionEn: "What does the Ijazah program cost?", questionAr: "ما تكلفة برنامج الإجازة؟", answerEn: "Pricing depends on the number of weekly sessions and your track (Tajweed or Hifz). Book a free assessment class and we will send you a personalized plan and quote.", answerAr: "السعر يعتمد على عدد الحصص الأسبوعية ومسارك (تجويد أو حفظ). احجز حصة تقييم مجانية وسنرسل لك خطة وعرض سعر مخصص." },
];
