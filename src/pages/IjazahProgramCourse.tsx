...
const IjazahProgramCourse = () => (
  <ServicePageLayout
    ...
    deepContentEn={[
      ...
      "The typical journey is: free assessment → short pre-Ijazah polishing (if needed) → opening of the Ijazah Khatmah → steady weekly Talaqqi at a pace your shaykh sets with you → oral exam → written Ijazah with the full Sanad. Some students pursue Ijazah in Tajweed only, some in Hifz only, and some complete both.",
